...
## Errors to be fixed
- Note: D:\Archivos\JOB\Spring_Boot\CleanArchitecture\base\src\test\java\com\example\base\user\infrastructure\controller\UserE2EIT.java uses unchecked or unsafe operations.
